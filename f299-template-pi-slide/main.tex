...
\section[Pitch \\ \footnotesize(2)]{Pitch}

\section[Problematização \\ \footnotesize(3)]{Problematização}
...
\section[Estado da Arte \\ \footnotesize(4–5)]{Estado da Arte}
...
\section[Objetivo \\ \footnotesize(6)]{Objetivo}
\begin{frame}{Objetivo}
\justifying
\begin{enumerate}
  \item Integrar elementos do TDC em tarefas em formato de jogo.
...
\section[Metodologia \\ \footnotesize(7–9)]{Metodologia}
...
\section[Apresentação prática \\ \footnotesize(8–9)]{Apresentação prática}

\section[Resultados \\ \footnotesize(10)]{Resultados}
...
\section[Conclusão \\ \footnotesize(11)]{Conclusão}
